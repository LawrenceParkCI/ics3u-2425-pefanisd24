...
public class UsingMathMethods {
 ...
 public static void main(String[] args) {
   ...
   * Math.pow(num, 2)  |280.5625   |16.0        |549.9024
   * Math.pow(num, num)|3.17868    |256.0       |NaN
   * Math.pow(num, 3)  |76746782   |64.0        |12895.2136
   * 
   */
  
  //*Why does the last value(-23.45) give strange output for Math.sqrt(num)? It gives a strange output because the number is a negative and you cant square root a negative.
   ...
   * abs: This gives you the distance of a number from zero, so it turns negative numbers into positive ones.
...
//  The pow method has 2 parameters because you need the base and and the exponent to calculate the power of a number.
